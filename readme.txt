...
- Semantic tags: <main>, <header>, <nav>, <footer>, <section> used throughout for proper document structure
...
Approximately 3-4 hours per day for 3 days, including design planning, coding, accessibility remediation, and validation testing.
...
There are multiple html files to run.
